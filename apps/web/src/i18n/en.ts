const en = {
  translation: {
    ...
    share: {
      button: 'Share',
      title: 'Share Canvas',
      description: 'Generate a shareable link to your canvas. Recipients can view it in read-only mode.',
      expiry: 'Link Expiry',
      expiryNever: 'Never',
      expiry24h: '24 Hours',
      expiry7d: '7 Days',
      allowFork: 'Allow viewers to fork (copy & edit)',
      ...
      readOnly: 'Read Only',
      forkButton: 'Fork & Edit',
      previewExpired: 'This link has expired.',
      previewNotFound: 'Canvas not found.',
      goHome: 'Go to Home',
    },
    common: {
      save: 'Save',
